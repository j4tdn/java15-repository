...
public class Ex02LocalTime {
	public static void main(String[] args) {
		...
		System.out.println("toString: " + optional(duration.toHoursPart(), "hours")
				+ optional(duration.toMinutesPart(), "minutes") + optional(duration.toSecondsPart(), "seconds"));
		System.out.println("===========fomat========");
		DateTimeFormatter df = DateTimeFormatter.ofPattern("HH:mm:ss");
		LocalTime time =LocalTime.now();
		System.out.println("formatted: " + df.format(time));
       LocalTime pasedTime= LocalTime.parse("15:30:45",df);
       System.out.println("pasedTime: " + pasedTime);
	}
}
