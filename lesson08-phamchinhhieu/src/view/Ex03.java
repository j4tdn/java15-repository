...
/**
 * 
 * 3: Viết chương trình nhập vào chuỗi TIẾNG VIỆT có dấu bất kì sau đó xuất ra
 * kết quả là chuỗi không dấu. Input: Em có yêu anh không anh để anh biết còn
 * chờ Em xin lỗi em đã có thái độ không phải với anh Output: Em co yeu anh
 * khong de anh biet con cho Em xin loi em da co thai do khong phai voi anh
 *
 */
public class Ex03 {
	...
	public static void main(String[] args) {
		String s = "Em có yêu anh không anh để anh biết còn chờ, Em xin lỗi em đã có thái độ không phải với anh";
		//System.out.println(removeAccent(s));
		System.out.println(removeAccent1(s));
	}
//cách 1
