...
public class Store {
    ...
    private Boolean isSelected;
     private BigDecimal expectedSalesInterpolated; 
    ...
    public void setStoreId(final Long storeId) {
     ...
     public void setExpectedSalesInterpolated(final BigDecimal expectedSalesInterpolated ) {
    	 this.expectedSalesInterpolated = expectedSalesInterpolated;
     }
     public  BigDecimal getExpectedSalesInterpolated( ) {
    	return expectedSalesInterpolated;
     }
    ...
    public BigDecimal getNotNullStockPreviousDay() {
    ...
    public BigDecimal getNotNullExpectedSales() {
