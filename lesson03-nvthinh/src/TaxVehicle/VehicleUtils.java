...
public class VehicleUtils {
	public static void main(String[] args) {
		System.out.println("======Menu lá»±a chá»�n=======");
		System.out.println("1.Nháº­p má»™t thÃ´ng tin khÃ¡ch hÃ ng");
		System.out.println("2.Xuáº¥t báº£n kÃª khai tiá»�n thuáº¿");
		System.out.println("3.ThoÃ¡t chÆ°Æ¡ng trÃ¬nh");
		VehicleUtils.add();
	...
	public static void add() {
		...
		if(luachon ==2) {
		System.out.printf("%-12s %-12s %-12s %-12s %-12s", "tÃªn chá»§ xe","loáº¡i xe", "dung tÃ­ch","trá»‹ giÃ¡", "thuáº¿ pháº£i ná»™p" );
		System.out.println();
		System.out.println("============================================================");
