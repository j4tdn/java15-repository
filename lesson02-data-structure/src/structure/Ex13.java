...
public class Ex13 {
	public static void main(String[] args) {
		...
		String o3 = new String("hello"); // H5
			System.out.println("o1 hash: " + System.identityHashCode(s1));
		System.out.println("o2 hash: " + System.identityHashCode(s2));
		System.out.println("o3 hash: " + System.identityHashCode(s3));
	}
}	
