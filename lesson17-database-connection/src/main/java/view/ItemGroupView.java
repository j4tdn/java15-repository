...
public class ItemGroupView {
	...
	public static void main(String[] args) {
		...
		itemGroupService.saveOrUpdate(new ItemGroup(1234,"Item Group 13422"));
		System.out.println("\n\n");
...
//		GET_ALL_IGS.forEach(System.out::println);
		...
		System.out.println("-----------3. Get item Group Details ----------");
		itemGroupService.getAllItemGroupDetails().forEach(System.out::println);
		System.out.println("\n\n");
