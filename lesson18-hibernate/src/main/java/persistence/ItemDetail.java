...
public class ItemDetail {
	...
	public ItemDetail(Id id, Item item, String image, Double salesPrice, Double buyPrice, Integer amount) {
		this.id = id;
		this.item = item;
		this.image = image;
	...
	public static class Id implements Serializable {
		...
		@Column(name = "MaMH", nullable = false, insertable = false, updatable = false)
